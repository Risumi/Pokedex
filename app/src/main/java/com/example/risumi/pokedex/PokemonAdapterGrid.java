...
public class PokemonAdapterGrid extends RecyclerView.Adapter<PokemonAdapterGrid.PokemonViewHolder> {
    ...
    public PokemonAdapterGrid(ArrayList<Pokemon> pokemonArrayList ) {
